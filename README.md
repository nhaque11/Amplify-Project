...
- Open/closed principle : This principle is applied to the game object file and the minigames incorporate those base features through inheritance. This allows for any new additional game to be added without changing the base class. So when you edit game functions or need to add a new game there is no need to do meitculoius changes that could affect the other games that are incorporated. 
